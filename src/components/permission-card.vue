<template>
  <div class="bg-white rounded-2xl overflow-hidden">
    <div class="relative bg-teal-500 text-white overflow-hidden p-4">
      <div class="text-xl font-bold">Web API 授權清單</div>
      <div class="text-xs flex flex-col gap-1 mt-2">
        <div>
          當狀態為
          <UIcon name="material-symbols:info" class="inline-block align-text-bottom" />
          時，點擊對應項目進行授權
        </div>
        <div>
          若狀態為
          <UIcon name="material-symbols:cancel" class="inline-block align-text-bottom" />
    ...
    <div class="relative overflow-hidden p-3 flex flex-col gap-1">
      ...
      >
        <UAvatar size="3xl" :icon="permission.icon" />
        ...
        <UIcon :name="permission.stateInfo.icon" :class="permission.stateInfo.color" size="2rem" />
      </UButton>
